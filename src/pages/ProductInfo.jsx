...
const ProductInfo = () => {
    ...
    <div className="max-w-6xl px-4 mx-auto">
        <div className="flex flex-wrap mb-24 -mx-4">
            <div className="flex w-full px-4 mb-8 md:w-1/2 md:items-center">
                <div className="">
                    <div className="">
                        <img
            ...
            <div className="w-full px-4 md:w-1/2">
                <div className="lg:pl-20">
                    <div className="mb-6 ">
                        <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-gray-700 md:text-2xl dark:text-gray-300">Hand Painted Blue Kaushalam Tea Pot in Aluminium
                        </h2>
                    ...
                    <div className="flex flex-wrap items-center mb-6">
                        <button
                            className="w-full px-4 py-3 text-center text-white  bg-blue-gray-500 border border-pink-600  hover:bg-pink-600 hover:text-gray-100 rounded-xl"
                        >Add to Cart
                        </button>
                    </div>
                </div>
