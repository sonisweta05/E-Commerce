          ...
          <div className="flex flex-wrap mb-24 -mx-4">
            ...
            <div className="w-full px-4 md:w-1/2">
              <div className="lg:pl-20">
                ...
                <div className="mb-6 " />
                <div className="flex flex-wrap items-center mb-6">
                  <button className="w-full px-4 py-3 text-center text-white  bg-blue-gray-500 border border-pink-600  hover:bg-pink-600 hover:text-gray-100 rounded-xl">
                    Add to Cart
                  </button>
                </div>
              </div>
